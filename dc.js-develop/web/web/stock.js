...
var categoryChart = dc.rowChart("#chart-row-category"),
    priceChart  = dc.rowChart("#chart-row-price"),
...
data.forEach(function(d) {
  ...
  console.log(data[0]);
    ...
    var fdata = crossfilter(data),
        ...
        categoryPerSource = eBayDim.group().reduceSum(function(d) {return d.count;}),
        queryDim = fdata.dimension(function(d) {return d.query;}),
        queryPerSource = sourceDim.group().reduceSum(function(e) {return e.query;}),
